...
public:
    AddTwoIntsServerNode() : Node("add_two_ints_server") 
    {
        server_ = this->create_service<example_interfaces::srv::AddTwoInts>(
            ...
            std::bind(&AddTwoIntsServerNode::callbackAddTwoInts, this, _1, _2)); // After using namespace std::placeholders
        RCLCPP_INFO(this->get_logger(), "Service 'add_two_ints' has been started.");
